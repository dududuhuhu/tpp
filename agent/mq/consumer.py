...
class Consumer(Service):
    ...
    # def __init__(self, amqp_url, exchange, routing_key, queue, exchange_type=ExchangeType.direct, handler=None, handler_arguments=()):
    ...
    #     self._handler_arguments = handler_arguments
    ...
    def _app_on_bindok(self, _unused_frame, userdata):
        print('bindok')
        # super().on_bindok(_unused_frame, userdata)
        # queue_name = userdata
        # self._queue_key_pairs[queue_name] = (
        #     self._queue_key_pairs[queue_name][0], True)
    ...
    #     ack = False
    #     if self._handler:
    #         ack = self._handler(*self._handler_arguments, channel=_unused_channel, deliver=basic_deliver, properties=properties, body=body)
    #     else:
